...
export const EditQuizWOImage = async (_token, _id, _tags, _description, _name) =>
{
  var formdata = new FormData()
...
export const EditQuiz = async (_token, _id, _tags, _description, _name, _image, _imageName) =>
{
  var formdata = new FormData()
  formdata.append("tags", _tags);
  formdata.append("description", _description);
